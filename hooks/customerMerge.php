...
// -------
//
function ciniki_sms_hooks_customerMerge($ciniki, $tnid, $args) {
    ...
    foreach($items as $i => $row) {
        $rc = ciniki_core_objectUpdate($ciniki, $tnid, 'ciniki.sms.message', $row['id'], array('customer_id'=>$args['primary_customer_id']), 0x04);
        if( $rc['stat'] != 'ok' ) {
    ...
    if( $updated > 0 ) {
        ...
        ciniki_tenants_updateModuleChangeDate($ciniki, $tnid, 'ciniki', 'sms');
    }
